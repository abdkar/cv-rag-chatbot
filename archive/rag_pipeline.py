...
from config import config, get_google_api_key, CHAT_PROMPT_TEMPLATE
from embeddings import get_embeddings
from file_processing import load_knowledge_base, load_uploaded_content
...
class RAGPipeline:
    ...
    def build_pipeline(self, use_uploaded: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            from file_processing import get_content_hash
