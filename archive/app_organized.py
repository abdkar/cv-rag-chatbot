...
from src.core.rag_pipeline import get_rag_pipeline, clear_pipeline_cache
...
class CVChatbotApp:
    ...
    def setup_page_config(self):
        ...
        st.set_page_config(
            ...
            layout="wide",  # Direct string instead of config value
            initial_sidebar_state="expanded"  # Direct string instead of config value
        )
